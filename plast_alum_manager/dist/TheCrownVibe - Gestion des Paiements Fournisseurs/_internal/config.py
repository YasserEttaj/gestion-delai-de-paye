...
DEFAULT_ADMIN_EMAIL = "admin@thecrownvibe.local"
LEGACY_DEFAULT_ADMIN_EMAILS = ("admin@plast-alum.local", "admin@yassbyte.local")
LEGACY_DEFAULT_ADMIN_PASSWORDS = ("Admin@12345", "admin12345")


DEFAULT_SETTINGS = {
    "company_name": COMPANY_NAME,
    "company_abbreviation": APP_ABBREVIATION,
    "app_title": APP_NAME,
    "default_language": "fr",
    "default_theme": "dark",
    "currency": "MAD",
...
LEGACY_ROLE_ACCOUNTANT = "Comptable"
