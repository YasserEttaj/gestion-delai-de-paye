...
a = Analysis(
    ...
    hiddenimports=['matplotlib.backends.backend_qtagg', 'app.models.user_model', 'app.models.supplier_model', 'app.models.invoice_model', 'app.models.payment_model', 'app.models.log_model', 'app.models.setting_model'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
